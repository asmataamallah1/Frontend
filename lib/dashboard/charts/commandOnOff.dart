...
class commandOnOff extends StatefulWidget {
  const commandOnOff({Key? key}) : super(key: key);

  @override
State<commandOnOff> createState() => _commandOnOff();
}
class _commandOnOff extends State<commandOnOff> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        toolbarHeight: (70.0),
        centerTitle: true,
        title: const Text('Command On/Off',
                          style: TextStyle(
                          fontSize: 25.0,
