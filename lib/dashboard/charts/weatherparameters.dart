...
class weatherparameters extends StatefulWidget {
  const weatherparameters({Key? key}) : super(key: key);

  @override
State<weatherparameters> createState() => _weatherparameters();
}
class _weatherparameters extends State<weatherparameters> {
              ...
              Row(
                children: [
                  ...
                  Container (
                    ...
                    child: 
                    Image.asset('assets/courbe1.png',
                          height:500 ,
                          width: 350,),
                  ),
                  ),
