...
class luminosity extends StatefulWidget {
  const luminosity({Key? key}) : super(key: key);

  @override
State<luminosity> createState() => _luminosity();
}
class _luminosity extends State<luminosity> {
